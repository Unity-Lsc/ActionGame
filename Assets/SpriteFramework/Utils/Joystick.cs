...
{
    public class Joystick : UIFormBase, IPointerDownHandler, IDragHandler, IPointerUpHandler
    {
        public float maxRadius = 100; //Handle 移动最大半径
        public Direction activatedAxis = (Direction)(-1); //选择激活的轴向
        [SerializeField] Image m_JoystickArea; //摇杆活动区域
        ...
        void ConfigJoystick() //配置动态/静态摇杆
        {
            ...
            m_JoystickArea.raycastTarget = dynamic;
