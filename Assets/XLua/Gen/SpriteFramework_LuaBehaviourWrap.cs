...
namespace XLua.CSObjectWrap
{
    ...
    public class SpriteFrameworkLuaBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(SpriteFramework.LuaBehaviour);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new SpriteFramework.LuaBehaviour();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to SpriteFramework.LuaBehaviour constructor!");
        ...
        static int _g_get_LuaScript(RealStatePtr L)
        {
		    try {
                ...
                SpriteFramework.LuaBehaviour gen_to_be_invoked = (SpriteFramework.LuaBehaviour)translator.FastGetCSObj(L, 1);
