...
public class UIScroller : MonoBehaviour
{
    ...
    public virtual void Start() {
        ...
        if (_movement == Arrangement.Horizontal) {
            viewCount = Mathf.CeilToInt(_scrollRect.GetComponent<RectTransform>().rect.width / itemWidth * 1.5f);
        } else {
            viewCount = Mathf.CeilToInt(_scrollRect.GetComponent<RectTransform>().rect.height / itemHeight * 1.5f);
        }
    ...
    private void CreateItem(int index) {
        ...
        //更新坐标
        itemScrollIndex.UpdateView(index, GetPosition(index));
